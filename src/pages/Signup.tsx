            ...
            <form onSubmit={handleVerifyOtp} className="space-y-5">
              ...
              >
                {verifying ? (
                  ...
                  <>
                    Verify Email
                    <IonIcon name="checkmark-circle-outline" size={18} style={{ color: "white" }} />
                  </>
                )}
              </motion.button>
            </form>
        ...
        <div className="flex-1 px-6 pb-8">
          ...
          >
              ...
              >
                ...
                <div className="relative">
                  <div className="absolute left-3.5 top-1/2 -translate-y-1/2">
                    <IonIcon name="person-outline" size={18} style={{ color: "hsl(var(--text-muted))" }} />
                  </div>
                  <input
                    type="text"
                    value={fullName}
            ...
            <motion.p
              ...
              className="mt-4 text-center text-[11px] font-sans leading-relaxed"
