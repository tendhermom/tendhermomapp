...
interface TechnicalPopupsProps {
  onBack?: () => void;
}
...
const popups = [
  {
    ...
    body:
      "TENDHERMOM LTD needs your location to power the Rescue Map and find the nearest hospitals in an emergency. Your location is only shared with your 5 contacts if you trigger the SOS alert.",
  },
  {
    icon: "people-outline",
    title: "Contacts Permission",
    body:
      "TENDHERMOM LTD needs access to your contacts so you can easily select 5 people to be notified in an emergency. We do not store or share your other contacts.",
  },
];

const TechnicalPopups = ({ onBack }: TechnicalPopupsProps = {}) => {
          ...
          >
            <div className="flex items-center gap-3 mb-3">
              <div className="w-[42px] h-[42px] rounded-[12px] flex items-center justify-center"
                ...
                <IonIcon name="information-circle" size={22} style={{ color: "hsl(var(--coral))" }} />
              </div>
            </div>
            <h1 className="text-white font-serif text-[26px] leading-tight tracking-[-0.01em]">Technical Pop-Ups</h1>
            <p className="text-white/60 text-[12px] font-sans mt-2">
              The exact wording shown when TendherMom asks for system permissions.
            </p>
          </motion.div>
              ...
              <motion.div key={idx} variants={fadeUp} className="tend-card overflow-hidden">
                <div className="flex items-center gap-3 px-5 pt-5 pb-3">
                  <div className="w-[36px] h-[36px] rounded-[10px] flex items-center justify-center flex-shrink-0"
                    ...
                    <IonIcon name={p.icon} size={18} style={{ color: "hsl(var(--green))" }} />
                  </div>
                ...
                <div className="px-5 pb-5">
                  <div
                    ...
                    style={{ background: "hsl(var(--light-green))" }}
                  >
                    <p className="text-[13px] font-sans leading-[1.7]" style={{ color: "hsl(var(--dark))" }}>
                      "{p.body}"
                    </p>
                  </div>
                </div>
...
export default TechnicalPopups;
